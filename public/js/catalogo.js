    ...
    function buscar_producto(consulta){
        ...
        $.post('../controllers/productoController.php',{consulta,funcion},(response)=>{
            ...
            PRODUCTS.forEach(product=>{
                ...
                template+=`
                <div prodId="${product.id_prod}" prodStock="${product.stock}" prodnombre="${product.nombre}" prodprecio="${product.precio}" prodcompos="${product.compos}" prodadici="${product.adici}" prodiva="${product.iva}" prodlab="${product.lab_id}" prodtipo="${product.tipo_id}" prodpres="${product.pres_id}" class="col-12 col-sm-6 col-md-2 align-items-stretch">
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-12">
                      <h2 class="lead"><b>${product.id_prod}</b></h2>
